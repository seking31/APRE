      ...
      <div *ngIf="showCalendar" class="calendar-popup">
        <div class="calendar">
          <div class="calendar__header">
            <button class="calendar__nav-button" (click)="debounce(prevMonth)">
              &#9664;
            </button>
            <span class="calendar__month">{{
              currentDate | date : 'MMMM yyyy'
            }}</span>
            <button class="calendar__nav-button" (click)="debounce(nextMonth)">
              &#9654;
            </button>
          </div>
          ...
          <div class="calendar__days">
            ...
            <div
              *ngFor="let day of daysInMonth; trackBy: trackByIndex"
              class="calendar__day"
